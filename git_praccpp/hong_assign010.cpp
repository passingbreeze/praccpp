...
public:
	...
	double str_to_double(string s){
		istringstream iss(s);
		iss.setf(ios::fixed | ios::showpoint); // setf 함수 출처 -> https://en.cppreference.com/w/cpp/io/ios_base/setf
		double f = 0.0;
	
	
		iss >> setprecision(2) >> f; // setprecision 함수 출처 -> https://en.cppreference.com/w/cpp/io/manip/setprecision
